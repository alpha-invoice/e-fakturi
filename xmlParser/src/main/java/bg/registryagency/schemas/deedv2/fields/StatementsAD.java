 ...
 *       &lt;sequence>
 *         &lt;element name="StatementAD" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsAD")
public class StatementsAD {

    @XmlElement(name = "StatementAD")
    protected List<StatementsAD.StatementAD> statementAD;
    ...
    /**
     * Gets the value of the statementAD property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementAD property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementAD().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsAD.StatementAD }
     * 
     * 
     */
    public List<StatementsAD.StatementAD> getStatementAD() {
        if (statementAD == null) {
            statementAD = new ArrayList<StatementsAD.StatementAD>();
        }
        return this.statementAD;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementAD
