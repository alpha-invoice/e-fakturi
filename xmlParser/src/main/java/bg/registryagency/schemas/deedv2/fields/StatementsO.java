 ...
 *       &lt;sequence>
 *         &lt;element name="StatementO" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsO")
public class StatementsO {

    @XmlElement(name = "StatementO")
    protected List<StatementsO.StatementO> statementO;
    ...
    /**
     * Gets the value of the statementO property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementO property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementO().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsO.StatementO }
     * 
     * 
     */
    public List<StatementsO.StatementO> getStatementO() {
        if (statementO == null) {
            statementO = new ArrayList<StatementsO.StatementO>();
        }
        return this.statementO;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementO
