 ...
 *       &lt;sequence>
 *         &lt;element name="StatementY" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsY")
public class StatementsY {

    @XmlElement(name = "StatementY")
    protected List<StatementsY.StatementY> statementY;
    ...
    /**
     * Gets the value of the statementY property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementY property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementY().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsY.StatementY }
     * 
     * 
     */
    public List<StatementsY.StatementY> getStatementY() {
        if (statementY == null) {
            statementY = new ArrayList<StatementsY.StatementY>();
        }
        return this.statementY;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementY
