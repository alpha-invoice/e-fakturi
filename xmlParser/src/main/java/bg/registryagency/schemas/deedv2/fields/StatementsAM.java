 ...
 *       &lt;sequence>
 *         &lt;element name="StatementAM" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsAM")
public class StatementsAM {

    @XmlElement(name = "StatementAM")
    protected List<StatementsAM.StatementAM> statementAM;
    ...
    /**
     * Gets the value of the statementAM property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementAM property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementAM().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsAM.StatementAM }
     * 
     * 
     */
    public List<StatementsAM.StatementAM> getStatementAM() {
        if (statementAM == null) {
            statementAM = new ArrayList<StatementsAM.StatementAM>();
        }
        return this.statementAM;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementAM
