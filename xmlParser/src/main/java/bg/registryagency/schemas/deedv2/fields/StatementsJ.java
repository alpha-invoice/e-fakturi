 ...
 *       &lt;sequence>
 *         &lt;element name="StatementJ" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsJ")
public class StatementsJ {

    @XmlElement(name = "StatementJ")
    protected List<StatementsJ.StatementJ> statementJ;
    ...
    /**
     * Gets the value of the statementJ property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementJ property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementJ().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsJ.StatementJ }
     * 
     * 
     */
    public List<StatementsJ.StatementJ> getStatementJ() {
        if (statementJ == null) {
            statementJ = new ArrayList<StatementsJ.StatementJ>();
        }
        return this.statementJ;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementJ
