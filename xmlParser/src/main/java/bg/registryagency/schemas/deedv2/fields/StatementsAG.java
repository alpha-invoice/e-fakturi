 ...
 *       &lt;sequence>
 *         &lt;element name="StatementAG" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsAG")
public class StatementsAG {

    @XmlElement(name = "StatementAG")
    protected List<StatementsAG.StatementAG> statementAG;
    ...
    /**
     * Gets the value of the statementAG property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementAG property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementAG().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsAG.StatementAG }
     * 
     * 
     */
    public List<StatementsAG.StatementAG> getStatementAG() {
        if (statementAG == null) {
            statementAG = new ArrayList<StatementsAG.StatementAG>();
        }
        return this.statementAG;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementAG
