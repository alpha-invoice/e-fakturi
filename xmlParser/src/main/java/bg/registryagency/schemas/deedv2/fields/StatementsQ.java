 ...
 *       &lt;sequence>
 *         &lt;element name="StatementQ" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsQ")
public class StatementsQ {

    @XmlElement(name = "StatementQ")
    protected List<StatementsQ.StatementQ> statementQ;
    ...
    /**
     * Gets the value of the statementQ property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementQ property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementQ().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsQ.StatementQ }
     * 
     * 
     */
    public List<StatementsQ.StatementQ> getStatementQ() {
        if (statementQ == null) {
            statementQ = new ArrayList<StatementsQ.StatementQ>();
        }
        return this.statementQ;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementQ
