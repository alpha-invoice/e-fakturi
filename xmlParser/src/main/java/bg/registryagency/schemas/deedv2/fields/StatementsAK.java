 ...
 *       &lt;sequence>
 *         &lt;element name="StatementAK" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsAK")
public class StatementsAK {

    @XmlElement(name = "StatementAK")
    protected List<StatementsAK.StatementAK> statementAK;
    ...
    /**
     * Gets the value of the statementAK property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementAK property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementAK().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsAK.StatementAK }
     * 
     * 
     */
    public List<StatementsAK.StatementAK> getStatementAK() {
        if (statementAK == null) {
            statementAK = new ArrayList<StatementsAK.StatementAK>();
        }
        return this.statementAK;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementAK
