 ...
 *       &lt;sequence>
 *         &lt;element name="StatementAC" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsAC")
public class StatementsAC {

    @XmlElement(name = "StatementAC")
    protected List<StatementsAC.StatementAC> statementAC;
    ...
    /**
     * Gets the value of the statementAC property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementAC property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementAC().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsAC.StatementAC }
     * 
     * 
     */
    public List<StatementsAC.StatementAC> getStatementAC() {
        if (statementAC == null) {
            statementAC = new ArrayList<StatementsAC.StatementAC>();
        }
        return this.statementAC;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementAC
