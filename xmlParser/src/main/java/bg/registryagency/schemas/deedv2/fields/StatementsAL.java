 ...
 *       &lt;sequence>
 *         &lt;element name="StatementAL" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsAL")
public class StatementsAL {

    @XmlElement(name = "StatementAL")
    protected List<StatementsAL.StatementAL> statementAL;
    ...
    /**
     * Gets the value of the statementAL property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementAL property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementAL().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsAL.StatementAL }
     * 
     * 
     */
    public List<StatementsAL.StatementAL> getStatementAL() {
        if (statementAL == null) {
            statementAL = new ArrayList<StatementsAL.StatementAL>();
        }
        return this.statementAL;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementAL
