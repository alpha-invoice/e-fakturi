 ...
 *       &lt;sequence>
 *         &lt;element name="UnlimitedLiabilityPartnerEUIE" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;all>
 ...
 *                   &lt;element name="NoObligationsEUIEText" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *                   &lt;element name="DateOfAcceptanceEUIE" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *                 &lt;/all>
...
@XmlType(name = "", propOrder = {
    "unlimitedLiabilityPartnerEUIE"
})
@XmlRootElement(name = "UnlimitedLiabilityPartnersEUIE")
public class UnlimitedLiabilityPartnersEUIE {
    ...
    /**
     * Gets the value of the unlimitedLiabilityPartnerEUIE property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the unlimitedLiabilityPartnerEUIE property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUnlimitedLiabilityPartnerEUIE().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public static class UnlimitedLiabilityPartnerEUIE {

        @XmlElement(name = "Subject", required = true)
        protected SubjectType subject;
        @XmlElement(name = "Address", required = true)
        protected AddressType address;
        @XmlElement(name = "NoObligationsEUIEText")
        protected int noObligationsEUIEText;
        @XmlElement(name = "DateOfAcceptanceEUIE", required = true)
        protected String dateOfAcceptanceEUIE;
        ...
        /**
         * Gets the value of the noObligationsEUIEText property.
         * 
         */
        public int getNoObligationsEUIEText() {
            return noObligationsEUIEText;
        }

        /**
         * Sets the value of the noObligationsEUIEText property.
         * 
         */
        public void setNoObligationsEUIEText(int value) {
            this.noObligationsEUIEText = value;
        }

        /**
         * Gets the value of the dateOfAcceptanceEUIE property.
         * 
         * @return
         *     possible object is
         *     {@link String }
         *     
         */
        public String getDateOfAcceptanceEUIE() {
            return dateOfAcceptanceEUIE;
        }

        /**
         * Sets the value of the dateOfAcceptanceEUIE property.
         * 
         * @param value
         *     allowed object is
         *     {@link String }
         *     
         */
        public void setDateOfAcceptanceEUIE(String value) {
            this.dateOfAcceptanceEUIE = value;
        }
