 ...
 *       &lt;sequence>
 *         &lt;element name="StatementB" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsB")
public class StatementsB {

    @XmlElement(name = "StatementB")
    protected List<StatementsB.StatementB> statementB;
    ...
    /**
     * Gets the value of the statementB property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementB property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementB().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsB.StatementB }
     * 
     * 
     */
    public List<StatementsB.StatementB> getStatementB() {
        if (statementB == null) {
            statementB = new ArrayList<StatementsB.StatementB>();
        }
        return this.statementB;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementB
