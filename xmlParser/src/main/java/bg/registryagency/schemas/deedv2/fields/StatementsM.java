 ...
 *       &lt;sequence>
 *         &lt;element name="StatementM" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsM")
public class StatementsM {

    @XmlElement(name = "StatementM")
    protected List<StatementsM.StatementM> statementM;
    ...
    /**
     * Gets the value of the statementM property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementM property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementM().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsM.StatementM }
     * 
     * 
     */
    public List<StatementsM.StatementM> getStatementM() {
        if (statementM == null) {
            statementM = new ArrayList<StatementsM.StatementM>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementM
