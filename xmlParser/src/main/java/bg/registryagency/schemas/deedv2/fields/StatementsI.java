 ...
 *       &lt;sequence>
 *         &lt;element name="StatementI" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsI")
public class StatementsI {

    @XmlElement(name = "StatementI")
    protected List<StatementsI.StatementI> statementI;
    ...
    /**
     * Gets the value of the statementI property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementI property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementI().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsI.StatementI }
     * 
     * 
     */
    public List<StatementsI.StatementI> getStatementI() {
        if (statementI == null) {
            statementI = new ArrayList<StatementsI.StatementI>();
        }
        return this.statementI;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementI
