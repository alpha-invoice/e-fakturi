 ...
 *       &lt;sequence>
 *         &lt;element name="StatementA" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsA")
public class StatementsA {

    @XmlElement(name = "StatementA")
    protected List<StatementsA.StatementA> statementA;
    ...
    /**
     * Gets the value of the statementA property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementA property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementA().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsA.StatementA }
     * 
     * 
     */
    public List<StatementsA.StatementA> getStatementA() {
        if (statementA == null) {
            statementA = new ArrayList<StatementsA.StatementA>();
        }
        return this.statementA;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementA
