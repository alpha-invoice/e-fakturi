 ...
 *       &lt;sequence>
 *         &lt;element name="StatementG" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsG")
public class StatementsG {

    @XmlElement(name = "StatementG")
    protected List<StatementsG.StatementG> statementG;
    ...
    /**
     * Gets the value of the statementG property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementG property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementG().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsG.StatementG }
     * 
     * 
     */
    public List<StatementsG.StatementG> getStatementG() {
        if (statementG == null) {
            statementG = new ArrayList<StatementsG.StatementG>();
        }
        return this.statementG;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementG
