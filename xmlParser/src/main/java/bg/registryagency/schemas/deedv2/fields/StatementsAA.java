 ...
 *       &lt;sequence>
 *         &lt;element name="StatementAA" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsAA")
public class StatementsAA {

    @XmlElement(name = "StatementAA")
    protected List<StatementsAA.StatementAA> statementAA;
    ...
    /**
     * Gets the value of the statementAA property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementAA property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementAA().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsAA.StatementAA }
     * 
     * 
     */
    public List<StatementsAA.StatementAA> getStatementAA() {
        if (statementAA == null) {
            statementAA = new ArrayList<StatementsAA.StatementAA>();
        }
        return this.statementAA;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementAA
