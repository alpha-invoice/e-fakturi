 ...
 *       &lt;sequence>
 *         &lt;element name="StatementN" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsN")
public class StatementsN {

    @XmlElement(name = "StatementN")
    protected List<StatementsN.StatementN> statementN;
    ...
    /**
     * Gets the value of the statementN property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementN property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementN().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsN.StatementN }
     * 
     * 
     */
    public List<StatementsN.StatementN> getStatementN() {
        if (statementN == null) {
            statementN = new ArrayList<StatementsN.StatementN>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementN
