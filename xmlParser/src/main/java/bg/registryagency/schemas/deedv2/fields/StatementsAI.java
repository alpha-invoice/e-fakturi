 ...
 *       &lt;sequence>
 *         &lt;element name="StatementAI" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsAI")
public class StatementsAI {

    @XmlElement(name = "StatementAI")
    protected List<StatementsAI.StatementAI> statementAI;
    ...
    /**
     * Gets the value of the statementAI property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementAI property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementAI().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsAI.StatementAI }
     * 
     * 
     */
    public List<StatementsAI.StatementAI> getStatementAI() {
        if (statementAI == null) {
            statementAI = new ArrayList<StatementsAI.StatementAI>();
        }
        return this.statementAI;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementAI
