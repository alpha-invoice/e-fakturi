 ...
 *       &lt;sequence>
 *         &lt;element name="StatementU" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsU")
public class StatementsU {

    @XmlElement(name = "StatementU")
    protected List<StatementsU.StatementU> statementU;
    ...
    /**
     * Gets the value of the statementU property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementU property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementU().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsU.StatementU }
     * 
     * 
     */
    public List<StatementsU.StatementU> getStatementU() {
        if (statementU == null) {
            statementU = new ArrayList<StatementsU.StatementU>();
        }
        return this.statementU;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementU
