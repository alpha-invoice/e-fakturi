 ...
 *       &lt;sequence>
 *         &lt;element name="StatementK" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsK")
public class StatementsK {

    @XmlElement(name = "StatementK")
    protected List<StatementsK.StatementK> statementK;
    ...
    /**
     * Gets the value of the statementK property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementK property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementK().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsK.StatementK }
     * 
     * 
     */
    public List<StatementsK.StatementK> getStatementK() {
        if (statementK == null) {
            statementK = new ArrayList<StatementsK.StatementK>();
        }
        return this.statementK;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementK
