 ...
 *       &lt;sequence>
 *         &lt;element name="StatementZ" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsZ")
public class StatementsZ {

    @XmlElement(name = "StatementZ")
    protected List<StatementsZ.StatementZ> statementZ;
    ...
    /**
     * Gets the value of the statementZ property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementZ property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementZ().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsZ.StatementZ }
     * 
     * 
     */
    public List<StatementsZ.StatementZ> getStatementZ() {
        if (statementZ == null) {
            statementZ = new ArrayList<StatementsZ.StatementZ>();
        }
        return this.statementZ;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementZ
