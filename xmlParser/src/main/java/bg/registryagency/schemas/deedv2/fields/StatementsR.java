 ...
 *       &lt;sequence>
 *         &lt;element name="StatementR" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsR")
public class StatementsR {

    @XmlElement(name = "StatementR")
    protected List<StatementsR.StatementR> statementR;
    ...
    /**
     * Gets the value of the statementR property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementR property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementR().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsR.StatementR }
     * 
     * 
     */
    public List<StatementsR.StatementR> getStatementR() {
        if (statementR == null) {
            statementR = new ArrayList<StatementsR.StatementR>();
        }
        return this.statementR;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementR
