 ...
 *       &lt;sequence>
 *         &lt;element name="StatementD" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsD")
public class StatementsD {

    @XmlElement(name = "StatementD")
    protected List<StatementsD.StatementD> statementD;
    ...
    /**
     * Gets the value of the statementD property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementD property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementD().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsD.StatementD }
     * 
     * 
     */
    public List<StatementsD.StatementD> getStatementD() {
        if (statementD == null) {
            statementD = new ArrayList<StatementsD.StatementD>();
        }
        return this.statementD;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementD
