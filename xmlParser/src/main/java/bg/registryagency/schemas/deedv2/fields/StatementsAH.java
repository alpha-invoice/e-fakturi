 ...
 *       &lt;sequence>
 *         &lt;element name="StatementAH" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsAH")
public class StatementsAH {

    @XmlElement(name = "StatementAH")
    protected List<StatementsAH.StatementAH> statementAH;
    ...
    /**
     * Gets the value of the statementAH property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementAH property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementAH().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsAH.StatementAH }
     * 
     * 
     */
    public List<StatementsAH.StatementAH> getStatementAH() {
        if (statementAH == null) {
            statementAH = new ArrayList<StatementsAH.StatementAH>();
        }
        return this.statementAH;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementAH
