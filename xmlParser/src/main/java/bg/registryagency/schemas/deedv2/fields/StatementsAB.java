 ...
 *       &lt;sequence>
 *         &lt;element name="StatementAB" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsAB")
public class StatementsAB {

    @XmlElement(name = "StatementAB")
    protected List<StatementsAB.StatementAB> statementAB;
    ...
    /**
     * Gets the value of the statementAB property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementAB property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementAB().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsAB.StatementAB }
     * 
     * 
     */
    public List<StatementsAB.StatementAB> getStatementAB() {
        if (statementAB == null) {
            statementAB = new ArrayList<StatementsAB.StatementAB>();
        }
        return this.statementAB;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementAB
