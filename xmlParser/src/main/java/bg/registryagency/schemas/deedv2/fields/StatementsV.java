 ...
 *       &lt;sequence>
 *         &lt;element name="StatementV" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsV")
public class StatementsV {

    @XmlElement(name = "StatementV")
    protected List<StatementsV.StatementV> statementV;
    ...
    /**
     * Gets the value of the statementV property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementV property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementV().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsV.StatementV }
     * 
     * 
     */
    public List<StatementsV.StatementV> getStatementV() {
        if (statementV == null) {
            statementV = new ArrayList<StatementsV.StatementV>();
        }
        return this.statementV;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementV
