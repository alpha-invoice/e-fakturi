 ...
 *       &lt;sequence>
 *         &lt;element name="StatementC" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsC")
public class StatementsC {

    @XmlElement(name = "StatementC")
    protected List<StatementsC.StatementC> statementC;
    ...
    /**
     * Gets the value of the statementC property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementC property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementC().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsC.StatementC }
     * 
     * 
     */
    public List<StatementsC.StatementC> getStatementC() {
        if (statementC == null) {
            statementC = new ArrayList<StatementsC.StatementC>();
        }
        return this.statementC;
    }
