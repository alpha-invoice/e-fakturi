 ...
 *       &lt;sequence>
 *         &lt;element name="StatementH" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsH")
public class StatementsH {

    @XmlElement(name = "StatementH")
    protected List<StatementsH.StatementH> statementH;
    ...
    /**
     * Gets the value of the statementH property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementH property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementH().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsH.StatementH }
     * 
     * 
     */
    public List<StatementsH.StatementH> getStatementH() {
        if (statementH == null) {
            statementH = new ArrayList<StatementsH.StatementH>();
        }
        return this.statementH;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementH
