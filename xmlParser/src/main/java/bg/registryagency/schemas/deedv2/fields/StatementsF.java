 ...
 *       &lt;sequence>
 *         &lt;element name="StatementF" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsF")
public class StatementsF {

    @XmlElement(name = "StatementF")
    protected List<StatementsF.StatementF> statementF;
    ...
    /**
     * Gets the value of the statementF property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementF property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementF().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsF.StatementF }
     * 
     * 
     */
    public List<StatementsF.StatementF> getStatementF() {
        if (statementF == null) {
            statementF = new ArrayList<StatementsF.StatementF>();
        }
        return this.statementF;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementF
