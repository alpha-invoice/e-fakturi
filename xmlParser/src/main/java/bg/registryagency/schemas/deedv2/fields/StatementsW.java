 ...
 *       &lt;sequence>
 *         &lt;element name="StatementW" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsW")
public class StatementsW {

    @XmlElement(name = "StatementW")
    protected List<StatementsW.StatementW> statementW;
    ...
    /**
     * Gets the value of the statementW property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementW property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementW().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsW.StatementW }
     * 
     * 
     */
    public List<StatementsW.StatementW> getStatementW() {
        if (statementW == null) {
            statementW = new ArrayList<StatementsW.StatementW>();
        }
        return this.statementW;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementW
