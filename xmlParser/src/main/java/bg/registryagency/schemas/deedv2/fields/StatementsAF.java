 ...
 *       &lt;sequence>
 *         &lt;element name="StatementAF" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsAF")
public class StatementsAF {

    @XmlElement(name = "StatementAF")
    protected List<StatementsAF.StatementAF> statementAF;
    ...
    /**
     * Gets the value of the statementAF property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementAF property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementAF().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsAF.StatementAF }
     * 
     * 
     */
    public List<StatementsAF.StatementAF> getStatementAF() {
        if (statementAF == null) {
            statementAF = new ArrayList<StatementsAF.StatementAF>();
        }
        return this.statementAF;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementAF
