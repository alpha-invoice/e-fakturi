 ...
 *       &lt;sequence>
 *         &lt;element name="StatementAE" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsAE")
public class StatementsAE {

    @XmlElement(name = "StatementAE")
    protected List<StatementsAE.StatementAE> statementAE;
    ...
    /**
     * Gets the value of the statementAE property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementAE property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementAE().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsAE.StatementAE }
     * 
     * 
     */
    public List<StatementsAE.StatementAE> getStatementAE() {
        if (statementAE == null) {
            statementAE = new ArrayList<StatementsAE.StatementAE>();
        }
        return this.statementAE;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementAE
