 ...
 *       &lt;sequence>
 *         &lt;element name="StatementL" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "StatementsL")
public class StatementsL {

    @XmlElement(name = "StatementL")
    protected List<StatementsL.StatementL> statementL;
    ...
    /**
     * Gets the value of the statementL property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementL property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementL().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementsL.StatementL }
     * 
     * 
     */
    public List<StatementsL.StatementL> getStatementL() {
        if (statementL == null) {
            statementL = new ArrayList<StatementsL.StatementL>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StatementL
